...
class Phase_Retrieval_Methods:
    ...
    def define_experiment_values(self):
        ...
        for current_exp in xml_doc.documentElement.getElementsByTagName("experiment"):
            ...
            if correct_exp == self.experiment_name:
                ...
                self.energy=float(self.getText(current_exp.getElementsByTagName("energy")[0]))*1e3 #For eV
    ...
    def process_MISTII_2(self):
        ...
        """
        self.result_MISTII_2 = processProjectionMISTII_2(self.sample_images, self.reference_images, self)
        ...
        NbIm, Nx, Ny=self.sample_images.shape
    ...
    def process_MISTII_1(self):
        ...
        Args:
            ...
            ddict [dictionnary]: experiment dictionnary
        """
        self.result_MISTII_1 = processProjectionMISTII_1(self.sample_images, self.reference_images, self)
    ...
    def process_LCS(self):
        ...
        Args:
            ...
            ddict [dictionnary]: experiment dictionnary
        """
        self.result_LCS=processProjectionLCS(self.sample_images, self.reference_images, self)
    ...
    def process_UMPA(self):
        ...
        self.result_UMPA=processProjectionUMPA(self.sample_images, self.reference_images, self)
    ...
    def process_OpticalFlow(self):
        ...
        self.result_OF = processProjectionOpticalFlow2020(self.sample_images, self.reference_images, self)
    ...
    def process_Pavlov2020(self):
        ...
        Args:
            ...
            ddict [dictionnary]: experiment dictionnary
        """
        absMask=gaussian_filter(self.sample_images,self.absorption_correction_sigma)/gaussian_filter(self.reference_images,self.absorption_correction_sigma)
        self.result_Pavlov2020 = pavlov2020(self.sample_images, self.reference_images,absMask, self )
    ...
    def process_MISTI(self):
        ...
        Args:
            ...
            ddict [dictionnary]: experiment dictionnary
        """
        self.result_MISTI = MISTI(self.sample_images, self.reference_images, self)
